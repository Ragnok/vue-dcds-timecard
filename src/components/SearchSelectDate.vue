<template>
  <on-click-outside :do="close">
    <div class="search-selectdate" :class="{ 'is-active': isOpen }">
      <button
        ref="button"
        @click="open"
        type="button"
      ...
      <div ref="dropdown" v-show="isOpen" class="search-selectdate-dropdown">
        <input
        ...
        <div v-show="filteredOptions.length === 0" class="search-selectdate-empty">
